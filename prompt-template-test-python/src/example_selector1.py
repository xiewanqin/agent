"""
对应 prompt-template-test/src/example-selector1.mjs
...
# 用字符长度近似控制；真实项目可换成 token 估算
# （Python 版 LengthBasedExampleSelector 直接构造即可，无 JS 的 fromExamples）
...
final_prompt = fewshot_prompt.format(current_requirement=current_requirement)
print(final_prompt)

# 流式输出（与 mjs 中 model.stream 一致）
print("\n=== AI 输出 ===")
